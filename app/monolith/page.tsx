  ...
  return (
    <main className={styles.page} id="top">
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroIndex}><span>GUEST</span><strong>01</strong><span>FIRST</span></div>
      </section>
      ...
      <section className={styles.projects} id="projects">
        ...
        {projects.map((project, index) => (
          <article className={styles.project} key={project.code}>
            ...
            <img className={styles.projectImage} src={project.cover} alt={`${project.name} project`} loading="lazy" />
        ...
        <div className={styles.practiceBody}>
          ...
          <div className={styles.disciplines}>
            {[
              ...
              <div key={number}><span>{number}</span><strong>{name}</strong><p>{note}</p></div>
            ))}
          </div>
      ...
      <section className={styles.contact} id="contact">
        <header><p>New business / collaborations</p><span>Cairo · Egypt</span></header>
